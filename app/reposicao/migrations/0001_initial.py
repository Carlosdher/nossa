# Generated by Django 2.0.7 on 2018-08-14 18:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Negada'), (1, 'Andamento'), (2, 'Aceita')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Planejamento',
            fields=[
                ('components', models.CharField(max_length=100, primary_key=True, serialize=False, verbose_name='Componente Curricular')),
        ...
        migrations.AddField(
            ...
            name='solicitation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Autorizacoes', to='reposicao.Solicitacao'),
        ),
    ]
